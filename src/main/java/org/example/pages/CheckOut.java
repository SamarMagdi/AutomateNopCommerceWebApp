...
public class CheckOut {
    ...
    /*a checkout page is the page(s) related to payment and shipping/billing details on an ecommerce store. The checkout page gives customers the opportunity to enter payment details and complete their order. The checkout process will collect: a customer's shipping details. billing details.*/
    ...
    public void fillBillingAddress() throws InterruptedException {
        ...
        select.selectByIndex(1);
        driver.findElement(city).sendKeys(PageObjectBase.generateString(5));
        driver.findElement(address1).sendKeys(PageObjectBase.generateString(5));
        driver.findElement(address2).sendKeys(PageObjectBase.generateString(5));
        driver.findElement(zipCode).sendKeys(PageObjectBase.generateString(5));
        driver.findElement(phoneNumber).sendKeys(PageObjectBase.generateString(5));
        driver.findElement(faxNumber).sendKeys(PageObjectBase.generateString(5));
    ...
    public void fillPaymentInformation() {
        ...
        select.selectByIndex(1);
        driver.findElement(cardHolderName).sendKeys(PageObjectBase.generateString(5) + " " + PageObjectBase.generateString(5));
